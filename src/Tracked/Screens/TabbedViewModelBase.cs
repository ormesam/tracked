...
namespace Tracked.Screens {
    public abstract class TabbedViewModelBase : ViewModelBase {
        public TabbedViewModelBase(MainContext context, TabItemType selectedTab) : base(context) {
            TabItems = new List<TabItem>(){
                new TabItem {
                    ...
                    IsSelected = selectedTab == TabItemType.Feed,
                    OnClick = Context.UI.GoToFeedScreen,
                },
                new TabItem {
                    Order = 1,
                ...
                new TabItem {
                    ...
                    IsSelected = selectedTab == TabItemType.Profile,
                    OnClick = () => Context.UI.GoToProfileScreenAsync(Context.Security.UserId, TabItemType.Profile),
                },
                new TabItem {
                    Order = 4,
                    ...
                    IsSelected = selectedTab == TabItemType.Settings,
