...
namespace Tracked.Droid.Auth {
    public class GoogleClientBaseException : Exception {
        ...
        public GoogleClientBaseException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientNotInitializedErrorException : GoogleClientBaseException {
        ...
        public GoogleClientNotInitializedErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInUnknownErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInUnknownErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInKeychainErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInKeychainErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInNoSignInHandlersInstalledErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInNoSignInHandlersInstalledErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInHasNoAuthInKeychainErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInHasNoAuthInKeychainErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInCanceledErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInCanceledErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInApiNotConnectedErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInApiNotConnectedErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInInvalidAccountErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInInvalidAccountErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInNetworkErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInNetworkErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInInternalErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInInternalErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInRequiredErrorErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInRequiredErrorErrorException(string message, Exception inner) : base(message, inner) { }
    }
    ...
    public class GoogleClientSignInFailedErrorException : GoogleClientBaseException {
        ...
        public GoogleClientSignInFailedErrorException(string message, Exception inner) : base(message, inner) { }
    }
}